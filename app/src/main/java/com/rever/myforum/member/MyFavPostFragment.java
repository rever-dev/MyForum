...
public class MyFavPostFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PostList.queryMyFavPost(activity, MemberBase.getMember().getId());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_my_fav_post, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = view.findViewById(R.id.myFavPost_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(activity));
        toolbar = view.findViewById(R.id.myFavPost_toolbar);
